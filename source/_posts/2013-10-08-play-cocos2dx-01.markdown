...
<div align="center"><img src="/images/Blog/Play_cocos2dx_01/1.jpg" alt="" border="0" title="设置环境变量" /><br></br></div>
...
<div align="center"><img src="/images/Blog/Play_cocos2dx_01/2.jpg" alt="" border="0" title="创建项目" /><br></br></div>

然后在cocos2d-x目录下的project就可以看到Test文件夹，里面包含了各个平台的项目。

<div align="center"><img src="/images/Blog/Play_cocos2dx_01/3.jpg" alt="" border="0" title="各平台项目" /><br></br></div>
...
<div align="center"><img src="/images/Blog/Play_cocos2dx_01/4.jpg" alt="" border="0" title="设置C++ build" /><br></br></div>

（4）添加C/C++→Builder→Environment→NDK_MODULE_PATH，值为cocos2dx目录和cocos2dx目录\cocos2dx\platform\third_party\android\prebuilt。

<div align="center"><img src="/images/Blog/Play_cocos2dx_01/5.jpg" alt="" border="0" title="设置NDK_MODULE_PATH" /><br></br></div>
...
<div align="center"><img src="/images/Blog/Play_cocos2dx_01/6.jpg" alt="" border="0" title="Eclipse编译" /><br></br></div>

**5.2.Cygwin编译**

这个请参见[传送门](http://blog.csdn.net/jackystudio/article/details/11516435)。编译完成后导入Eclipse即可。

<div align="center"><img src="/images/Blog/Play_cocos2dx_01/7.jpg" alt="" border="0" title="CygWin编译" /><br></br></div>
